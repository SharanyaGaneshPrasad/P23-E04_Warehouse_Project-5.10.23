...
class Test_classes(unittest.TestCase):
    ...
    #     # Employee with name, pwd and set is_authenticated to True
        e2=Employee(user_name="DCI", password="zzzz")
    ...
    #     # Warehouse obj with id 1) to check stock property 2)chec for occupancy method
        ...
        w2.add_item(i2)
        w2.add_item(i4)
        self.assertEqual(w2.occupancy(),stock_len+4, "Incorrect the method occupancy should return the len of stock list")
    #     # testing search method
        w2.add_item(i2)
        w2.add_item(i3)
        w2.add_item(i4)
        w2.add_item(i2)
        # result=w2.search("Red Mouse")
        # print(f"Result of search function : {result}")
        self.assertEqual( [('Red Mouse', '2021-05-26 17:20:10'), ('Red Mouse', '2021-05-26 17:20:10'), ('Red Mouse', '2021-05-26 17:20:10'), ('Red Mouse', '2021-05-26 17:20:10')], w2.search("Red Mouse"), "Incorrect there are 4 quantuty of Red Mouse in the stock")
        self.assertEqual( [('Red Mouse', '2021-05-26 17:20:10'), ('Red Mouse', '2021-05-26 17:20:10'), ('Red Mouse', '2021-05-26 17:20:10'), ('Red Mouse', '2021-05-26 17:20:10')], w2.search("rED mOUse"), "Incorrect there are 3 quantuty of item2 in the stock")
